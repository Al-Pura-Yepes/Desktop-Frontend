            ...
            children: [
              ...
              SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    Text('Nombre del producto', style: textTheme.titleSmall?.copyWith(fontSize: 17),),
                    Text('Datos adicionales del producto', style: textTheme.bodyMedium?.copyWith(fontSize: 15),)
                  ],
                ),
              ),
            ],
      ...
      child: Row(
        children: [
          ...
          GestureDetector(
            ...
            child: const Icon(Icons.remove, color: Color(0xffC8C8C8),)
